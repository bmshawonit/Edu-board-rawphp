                                  ...
                                  <div class="card-body">
                                    ...
                                    <?php  
                                        ...
                                        if( isset($_POST['submit']) ){
                                          ...
                                          $sql = "SELECT * FROM students_info WHERE student_id = '$sid'";
                                          $data =  $conn -> query( $sql);
                                          ...
                                          $data_by_id = $data -> fetch_assoc();
                                            ...
                                            $institute = $data_by_id['institute'];
                                          ...
                                          // bangla  Management 
                                            ...
                                            $final_cgpa = round($student_cgpa, 2);
                                            ...
                                            if( empty($ban) || empty($eng) || empty($math) || empty($science) || empty($ss) || empty( $religion)  ){
                                                ...
                                                $sql = "INSERT INTO students_results (  name, roll, reg, board, ins, photo , ban_m, ban_g, ban_gpa, en_m, en_g, en_gpa, mat_m, mat_g, mat_gpa, s_m, s_g, s_gpa, ss_m, ss_g, ss_gpa, r_m, r_g, r_gpa, tgrade, cgpa, result) VALUES ( '$name', '$roll', '$reg', '$board', '$institute', '$photo', '$ban', '$ban_g', '$ban_gpa', '$eng', '$eng_g', '$eng_gpa', '$math', '$math_g', '$math_gpa', '$science', '$s_g', '$s_gpa', '$ss', '$ss_g', '$ss_gpa', '$religion', '$r_g', '$r_gpa', '$tgrade', '$final_cgpa', '$result')";
                                                $conn -> query($sql);
