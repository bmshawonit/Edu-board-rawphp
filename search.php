<?php  
	...
	include_once "edu-admin/libs/functions.php";
		...
		<div class="w-main">
				...
				<div class="student-info">
					<div class="student-photo">
						<img src="edu-admin/students_photos/<?php echo $search_result_data['photo'];  ?>" alt="">
					</div>
				...
				<div class="student-result">
					<table>
						...
						<tr>
							<td>Math</td>
							<td><?php echo $search_result_data['mat_m'];  ?></td>
							<td><?php echo $search_result_data['mat_g'];  ?></td>
							<td><?php echo $search_result_data['mat_gpa'];  ?></td>
						</tr>
						<tr>
							<td>Science</td>
