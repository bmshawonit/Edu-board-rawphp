                            ...
                            <div class="slim-scroll" data-height="auto" data-disable-fade-out="true" data-distance="0" data-size="10px" data-railOpacity="0.2">
                                ...
                                <nav class="nav-primary hidden-xs batch268">
                                    ...
                                    <ul class="nav nav-main" data-ride="collapse">
                                        ...
                                        <li>
                                            <a href="#" class="auto"> <span class="pull-right text-muted"> <i class="i i-circle-sm-o text"></i> <i class="i i-circle-sm text-active"></i> </span> <i class="i i-stack icon"> </i> <span class="font-bold">Students</span> </a>
                                            <ul class="nav dk">
                                                <li>
                                                    <a href="all_students.php" class="auto"> <i class="i i-dot"></i> <span>All students</span> </a>
                                                </li>
                                                <li>
                                                    <a href="add_new_students.php" class="auto"> <i class="i i-dot"></i> <span>Add new students</span> </a>
                                                </li>
